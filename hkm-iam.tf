...
module "set_folder_iam_base_tables" {
  ...
  bindings  = {
    "serviceAccount:cc-sa-1032604889204@pj-data-pipeline-devel.iam.gserviceaccount.com" = ["roles/bigquery.dataViewe"],
    "serviceAccount:cc-sa-632753434802@pj-data-pipeline-staging.iam.gserviceaccount.com" = ["roles/bigquery.dataViewe"],
    "serviceAccount:cc-sa-841149115454@pj-data-pipeline-prod.iam.gserviceaccount.com" = ["roles/bigquery.dataViewe"]
  }
